...
public interface CustomFormTagService {
    ...
    List<String> selectCustomFormIdsForMassageContent(JSONObject jsonObject);
    ...
    String selectTagIdByTagName(JSONObject tagJSONObject);

    List<String> selectCustomFormIdsByTagId(String tagId, String key);
